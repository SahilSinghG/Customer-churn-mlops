...
class ModelTrainer:
    ...
    def handle_class_imbalance(self, X_train, y_train):
        ...
        print(f"Before SMOTE - Class 0: {original_counts[0]}, Class 1: {original_counts[1]}")
        ...
        print(f"After SMOTE - Class 0: {balanced_counts[0]}, Class 1: {balanced_counts[1]}")
        ...
        for model_name, config in models_config.items():
            ...
            with mlflow.start_run(run_name=model_name):
                try:
                    ...
                    # Evaluate
                    metrics, cm, clf_report = self.evaluate_model(model, X_test, y_test, model_name)
    ...
    def save_best_model(self):
        ...
        if self.best_model:
            ...
            metadata = {
                ...
                'features_count': int(model.n_features_in_) if hasattr(model, 'n_features_in_') else 'unknown'
            }
...
def main():
    ...
    # Train models
    models, results = trainer.train_models(X_train, X_test, y_train, y_test, use_smote=True)
